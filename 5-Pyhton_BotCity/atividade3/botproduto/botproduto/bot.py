...
import sys
sys.path.append(r'planilha\planilha.py')
import os
...
def main():
    ...
    df = planilha.ler_excel('C:\\Users\\matutino\\Desktop\\ZlAcademy-Millena\\atividade3\\botproduto\\planilha\\RelacaoProduto.xlsx', 'Plan1')
